    ...
    */
    const underlingSource = {
      ...
      async pull(controller) {
        ...
        // if source is drained, something left in buffer and receivers internal queue not full
        const isFinalChunkLeft = isDone && currentBuffer && currentBuffer.length < segmentSizeDefault  && controller.desiredSize > 0
