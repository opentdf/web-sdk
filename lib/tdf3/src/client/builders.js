...
class EncryptParamsBuilder {
  ...
  /**
   * Specify the content to encrypt, in web stream form. Returns this object for method chaining.
   * @param {Readable} readStream - a Readable Stream to encrypt.
   * @return {EncryptParamsBuilder} - this object.
   */
  withWebStreamSource(readStream) {
    readStream = webStreams.toNodeReadable(readStream);
...
class DecryptParamsBuilder {
  ...
  /**
   * Specify the TDF ciphertext to decrypt, in web stream form. Returns this object for method chaining.
   * @param {Readable} stream - a Readable stream to decrypt.
   * @return {DecryptParamsBuilder} - this object.
   */
  withWebStreamSource(stream) {
    stream = webStreams.toNodeReadable(stream);
  ...
  /**
   * Use it with .withStreamSource or .withWebStreamSource
   * @param rcaParams
