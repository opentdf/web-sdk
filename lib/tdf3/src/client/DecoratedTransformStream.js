...
class DecoratedTransformStream extends TransformStream {
  constructor(byteLimit) {
    super(undefined, { highWaterMark: byteLimit }, { highWaterMark: byteLimit });
    Object.assign(this, new EventEmitter()) // for custom events
  }
...
export default DecoratedTransformStream;
