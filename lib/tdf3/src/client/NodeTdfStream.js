...
class NodeTdfStream extends DecoratedTransformStream {
   ...
   */
  async toBuffer() {
    return await buffer(this.readable);
  }
  ...
  async toFile(filepath, encoding) {
    ...
    return new Promise((resolve, reject) => {
      ...
      // console.log('toNodeReadable(this.readable)');
      // this.readable.pipeTo(file);
      // file.on('finish', () => {
      //   console.log('finish')
      //   resolve();
      // });
