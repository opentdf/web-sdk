...
import { NanoTDF } from '../../src/nano/nanotdf/index.js';
import PolicyTypeEnum from '../../src/nano/nanotdf/enum/PolicyTypeEnum.js';
import bufferToHex from './helpers/bufferToHex.js';
import * as remoteFixture from '../../src/nano/__fixtures__/nanotdf-spec-remote-example.js';

import * as embeddedFixture from '../../src/nano/__fixtures__/nanotdf-spec-embedded-example.js';
import * as plainEmbeddedFixture from '../../src/nano/__fixtures__/nanotdf-spec-plain-embedded-example.js';
