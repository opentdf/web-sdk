...
export async function encryptConfiguration(opts: WriteTdfOptions): Promise<EncryptConfiguration> {
  ...
  return {
    ...
    rootIntegrityAlgorithm: opts.rootIntegrityAlgorithm ?? ROOT_INTEGRITY_ALGORITHM,
    keyForEncryption: keyInfo,
    keyForManifest: keyInfo,
    policy: Mocks.getPolicyObject(),
    segmentIntegrityAlgorithm: opts.segmentIntegrityAlgorithm ?? SEGMENT_INTEGRITY_ALGORITHM,
