...
describe('encrypt decrypt test', async function () {
  ...
  for (const encapKeyType of ['ec:secp256r1', 'rsa:2048', 'mlkem:512', 'mlkem:768', 'mlkem:1024'] as KasPublicKeyAlgorithm[]) {
    for (const rewrapKeyType of ['ec:secp256r1', 'rsa:2048', 'mlkem:512', 'mlkem:768', 'mlkem:1024'] as KasPublicKeyAlgorithm[]) {
