...
describe('Local roundtrip Tests', () => {
  ...
  it.skip('golden file', async () => {
    const cipherText = base64.decodeArrayBuffer(
      ''
    );
    const client = new NanoTDFClient({
      authProvider,
      kasEndpoint,
      kasAliases: { 'http://localhost:8080': 'http://localhost:3000' },
    });
