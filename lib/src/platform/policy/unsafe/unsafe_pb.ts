 ...
 * WARNING!!
 *
 * @generated from message policy.unsafe.UnsafeDeletePublicKeyRequest
 */
export type UnsafeDeletePublicKeyRequest = Message<"policy.unsafe.UnsafeDeletePublicKeyRequest"> & {
  /**
   * Required
   * UUID of the Key
   *
...
/**
 * Describes the message policy.unsafe.UnsafeDeletePublicKeyRequest.
 * Use `create(UnsafeDeletePublicKeyRequestSchema)` to create a new message.
 */
export const UnsafeDeletePublicKeyRequestSchema: GenMessage<UnsafeDeletePublicKeyRequest> = /*@__PURE__*/
  messageDesc(file_policy_unsafe_unsafe, 18);

/**
 * @generated from message policy.unsafe.UnsafeDeletePublicKeyResponse
 */
export type UnsafeDeletePublicKeyResponse = Message<"policy.unsafe.UnsafeDeletePublicKeyResponse"> & {
  /**
...
/**
 * Describes the message policy.unsafe.UnsafeDeletePublicKeyResponse.
 * Use `create(UnsafeDeletePublicKeyResponseSchema)` to create a new message.
 */
export const UnsafeDeletePublicKeyResponseSchema: GenMessage<UnsafeDeletePublicKeyResponse> = /*@__PURE__*/
...
export const UnsafeService: GenService<{
   ...
   * ---------------------------------------
   *
   * @generated from rpc policy.unsafe.UnsafeService.UnsafeDeletePublicKey
   */
  unsafeDeletePublicKey: {
    methodKind: "unary";
    input: typeof UnsafeDeletePublicKeyRequestSchema;
    output: typeof UnsafeDeletePublicKeyResponseSchema;
  },
}> = /*@__PURE__*/
