...
import type { Attribute, AttributeRuleTypeEnum, KasKey, KeyMode, Namespace, Value } from "../objects_pb.js";
...
export const file_policy_unsafe_unsafe: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_google_protobuf_wrappers, file_policy_objects]);
...
export type UnsafeDeleteKasKeyResponse = Message<"policy.unsafe.UnsafeDeleteKasKeyResponse"> & {
  /**
   * @generated from field: policy.KasKey key = 1;
   */
  key?: KasKey;
};
...
/**
 * WARNING!!
 * Updating a key in place can retroactively alter decryptability for existing TDFs.
 * This support-only operation is limited to switching between REMOTE and PUBLIC_KEY_ONLY
 * key modes, or updating the provider configuration for an existing REMOTE key, while
 * preserving the existing KID, KAS URI, and public key.
 *
 * @generated from message policy.unsafe.UnsafeUpdateKeyRequest
 */
export type UnsafeUpdateKeyRequest = Message<"policy.unsafe.UnsafeUpdateKeyRequest"> & {
  /**
   * Required
   * UUID of the Key
   *
  ...
  /**
   * Optional
   * Target key mode. Only KEY_MODE_REMOTE and KEY_MODE_PUBLIC_KEY_ONLY mode changes are supported.
   * KEY_MODE_UNSPECIFIED with provider_config_id updates only the provider configuration for an existing REMOTE key.
   *
   * @generated from field: policy.KeyMode target_key_mode = 2;
   */
  targetKeyMode: KeyMode;

  /**
   * Conditionally Required
   * Configuration ID for the key provider. Required for KEY_MODE_REMOTE and KEY_MODE_UNSPECIFIED; empty for KEY_MODE_PUBLIC_KEY_ONLY.
   *
   * @generated from field: string provider_config_id = 3;
   */
  providerConfigId: string;
};

/**
 * Describes the message policy.unsafe.UnsafeUpdateKeyRequest.
 * Use `create(UnsafeUpdateKeyRequestSchema)` to create a new message.
 */
export const UnsafeUpdateKeyRequestSchema: GenMessage<UnsafeUpdateKeyRequest> = /*@__PURE__*/
  messageDesc(file_policy_unsafe_unsafe, 20);

/**
 * @generated from message policy.unsafe.UnsafeUpdateKeyResponse
 */
export type UnsafeUpdateKeyResponse = Message<"policy.unsafe.UnsafeUpdateKeyResponse"> & {
  /**
   * @generated from field: policy.KasKey key = 1;
   */
  key?: KasKey;
...
/**
 * Describes the message policy.unsafe.UnsafeUpdateKeyResponse.
 * Use `create(UnsafeUpdateKeyResponseSchema)` to create a new message.
 */
export const UnsafeUpdateKeyResponseSchema: GenMessage<UnsafeUpdateKeyResponse> = /*@__PURE__*/
  messageDesc(file_policy_unsafe_unsafe, 21);
...
export const UnsafeService: GenService<{
   ...
   * ---------------------------------------
   *
   * @generated from rpc policy.unsafe.UnsafeService.UnsafeUpdateKey
   */
  unsafeUpdateKey: {
    methodKind: "unary";
    input: typeof UnsafeUpdateKeyRequestSchema;
    output: typeof UnsafeUpdateKeyResponseSchema;
  },
  /**
