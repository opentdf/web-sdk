 ...
 *
 * @generated from message policy.namespaces.AssignKeyToNamespaceRequest
 */
export type AssignKeyToNamespaceRequest = Message<"policy.namespaces.AssignKeyToNamespaceRequest"> & {
  /**
...
/**
 * Describes the message policy.namespaces.AssignKeyToNamespaceRequest.
 * Use `create(AssignKeyToNamespaceRequestSchema)` to create a new message.
 */
export const AssignKeyToNamespaceRequestSchema: GenMessage<AssignKeyToNamespaceRequest> = /*@__PURE__*/
  messageDesc(file_policy_namespaces_namespaces, 16);

/**
 * @generated from message policy.namespaces.AssignKeyToNamespaceResponse
 */
export type AssignKeyToNamespaceResponse = Message<"policy.namespaces.AssignKeyToNamespaceResponse"> & {
  /**
   * @generated from field: policy.namespaces.NamespaceKey namespace_key = 1;
   */
  namespaceKey?: NamespaceKey;
...
/**
 * Describes the message policy.namespaces.AssignKeyToNamespaceResponse.
 * Use `create(AssignKeyToNamespaceResponseSchema)` to create a new message.
 */
export const AssignKeyToNamespaceResponseSchema: GenMessage<AssignKeyToNamespaceResponse> = /*@__PURE__*/
  messageDesc(file_policy_namespaces_namespaces, 17);

/**
 * @generated from message policy.namespaces.RemoveKeyFromNamespaceRequest
 */
export type RemoveKeyFromNamespaceRequest = Message<"policy.namespaces.RemoveKeyFromNamespaceRequest"> & {
  /**
   * @generated from field: policy.namespaces.NamespaceKey namespace_key = 1;
   */
  namespaceKey?: NamespaceKey;
...
/**
 * Describes the message policy.namespaces.RemoveKeyFromNamespaceRequest.
 * Use `create(RemoveKeyFromNamespaceRequestSchema)` to create a new message.
 */
export const RemoveKeyFromNamespaceRequestSchema: GenMessage<RemoveKeyFromNamespaceRequest> = /*@__PURE__*/
  messageDesc(file_policy_namespaces_namespaces, 18);

/**
 * @generated from message policy.namespaces.RemoveKeyFromNamespaceResponse
 */
export type RemoveKeyFromNamespaceResponse = Message<"policy.namespaces.RemoveKeyFromNamespaceResponse"> & {
  /**
   * @generated from field: policy.namespaces.NamespaceKey namespace_key = 1;
   */
  namespaceKey?: NamespaceKey;
...
/**
 * Describes the message policy.namespaces.RemoveKeyFromNamespaceResponse.
 * Use `create(RemoveKeyFromNamespaceResponseSchema)` to create a new message.
 */
export const RemoveKeyFromNamespaceResponseSchema: GenMessage<RemoveKeyFromNamespaceResponse> = /*@__PURE__*/
...
export const NamespaceService: GenService<{
   ...
   * ---------------------------------------
   *
   * @generated from rpc policy.namespaces.NamespaceService.AssignKeyToNamespace
   */
  assignKeyToNamespace: {
    methodKind: "unary";
    input: typeof AssignKeyToNamespaceRequestSchema;
    output: typeof AssignKeyToNamespaceResponseSchema;
  },
  /**
   * @generated from rpc policy.namespaces.NamespaceService.RemoveKeyFromNamespace
   */
  removeKeyFromNamespace: {
    methodKind: "unary";
    input: typeof RemoveKeyFromNamespaceRequestSchema;
    output: typeof RemoveKeyFromNamespaceResponseSchema;
  },
}> = /*@__PURE__*/
