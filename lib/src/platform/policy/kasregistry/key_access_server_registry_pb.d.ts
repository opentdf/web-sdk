...
export class GetKeyAccessServerRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: GetKeyAccessServerRequest
  ): GetKeyAccessServerRequest.AsObject;
...
export class GetKeyAccessServerResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: GetKeyAccessServerResponse
  ): GetKeyAccessServerResponse.AsObject;
  static serializeBinaryToWriter(
...
export class ListKeyAccessServersRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ListKeyAccessServersRequest
  ): ListKeyAccessServersRequest.AsObject;
  static serializeBinaryToWriter(
...
export class ListKeyAccessServersResponse extends jspb.Message {
  ...
  setKeyAccessServersList(
    value: Array<policy_objects_pb.KeyAccessServer>
  ): ListKeyAccessServersResponse;
  clearKeyAccessServersList(): ListKeyAccessServersResponse;
  addKeyAccessServers(
    value?: policy_objects_pb.KeyAccessServer,
    index?: number
  ): policy_objects_pb.KeyAccessServer;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ListKeyAccessServersResponse.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: ListKeyAccessServersResponse
  ): ListKeyAccessServersResponse.AsObject;
  static serializeBinaryToWriter(
...
export class CreateKeyAccessServerRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CreateKeyAccessServerRequest
  ): CreateKeyAccessServerRequest.AsObject;
  static serializeBinaryToWriter(
...
export class CreateKeyAccessServerResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CreateKeyAccessServerResponse
  ): CreateKeyAccessServerResponse.AsObject;
  static serializeBinaryToWriter(
...
export class UpdateKeyAccessServerRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: UpdateKeyAccessServerRequest
  ): UpdateKeyAccessServerRequest.AsObject;
  static serializeBinaryToWriter(
...
export class UpdateKeyAccessServerResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: UpdateKeyAccessServerResponse
  ): UpdateKeyAccessServerResponse.AsObject;
  static serializeBinaryToWriter(
...
export class DeleteKeyAccessServerRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DeleteKeyAccessServerRequest
  ): DeleteKeyAccessServerRequest.AsObject;
  static serializeBinaryToWriter(
...
export class DeleteKeyAccessServerResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: DeleteKeyAccessServerResponse
  ): DeleteKeyAccessServerResponse.AsObject;
  static serializeBinaryToWriter(
