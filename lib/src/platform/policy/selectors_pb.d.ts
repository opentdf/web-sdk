...
export class AttributeNamespaceSelector extends jspb.Message {
  ...
  setWithAttributes(
    value?: AttributeNamespaceSelector.AttributeSelector
  ...
  static toObject(
    ...
    msg: AttributeNamespaceSelector
  ): AttributeNamespaceSelector.AsObject;
...
export namespace AttributeNamespaceSelector {
  ...
  export class AttributeSelector extends jspb.Message {
    ...
    setWithValues(
      value?: AttributeNamespaceSelector.AttributeSelector.ValueSelector
    ): AttributeSelector;
...
export class AttributeDefinitionSelector extends jspb.Message {
  ...
  setWithNamespace(
    value?: AttributeDefinitionSelector.NamespaceSelector
  ...
  static toObject(
    includeInstance: boolean,
    msg: AttributeDefinitionSelector
  ): AttributeDefinitionSelector.AsObject;
  static serializeBinaryToWriter(
...
export class AttributeValueSelector extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: AttributeValueSelector
  ): AttributeValueSelector.AsObject;
...
export namespace AttributeValueSelector {
  ...
  export class AttributeSelector extends jspb.Message {
    ...
    setWithNamespace(
      value?: AttributeValueSelector.AttributeSelector.NamespaceSelector
    ): AttributeSelector;
    hasWithNamespace(): boolean;
