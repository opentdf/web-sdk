...
export class WellKnownConfig extends jspb.Message {
  ...
  static deserializeBinaryFromReader(message: WellKnownConfig, reader: jspb.BinaryReader): WellKnownConfig;
}
...
export class GetWellKnownConfigurationRequest extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: GetWellKnownConfigurationRequest): GetWellKnownConfigurationRequest.AsObject;
  static serializeBinaryToWriter(message: GetWellKnownConfigurationRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetWellKnownConfigurationRequest;
  static deserializeBinaryFromReader(message: GetWellKnownConfigurationRequest, reader: jspb.BinaryReader): GetWellKnownConfigurationRequest;
}
...
export class GetWellKnownConfigurationResponse extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: GetWellKnownConfigurationResponse): GetWellKnownConfigurationResponse.AsObject;
  static serializeBinaryToWriter(message: GetWellKnownConfigurationResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetWellKnownConfigurationResponse;
  static deserializeBinaryFromReader(message: GetWellKnownConfigurationResponse, reader: jspb.BinaryReader): GetWellKnownConfigurationResponse;
}
