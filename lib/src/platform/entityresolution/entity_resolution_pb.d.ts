...
export class ResolveEntitiesRequest extends jspb.Message {
  ...
  addEntities(
    value?: authorization_authorization_pb.Entity,
    index?: number
  ): authorization_authorization_pb.Entity;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ResolveEntitiesRequest.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: ResolveEntitiesRequest
  ): ResolveEntitiesRequest.AsObject;
...
export class EntityRepresentation extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: EntityRepresentation
  ): EntityRepresentation.AsObject;
...
export class ResolveEntitiesResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: ResolveEntitiesResponse
  ): ResolveEntitiesResponse.AsObject;
