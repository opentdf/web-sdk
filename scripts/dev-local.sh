...
export VITE_TDF_CFG="{\"oidc\":{\"host\":\"${APP_URL}/auth/realms/${KC_REALM}\",\"clientId\":\"${KC_CLIENT_ID}\"},\"kas\":\"${PLATFORM_URL}/api/kas\",\"reader\":\"https://secure.virtru.com/start?htmlProtocol=1\"}"
